...
- Julia ...
  - encouraged me to add [**pkgdown** site](https://rvlenth.github.io/emmeans/) (July '24)
...
::: {.incremental}
1. I filed an issue in 2024 (to make [**pkgdown**](https://pkgdown.r-lib.org/) website) and assisted with implementing it, realized Russ was 77 years old, and inquired about package succession.
...
::: {.incremental}
- **Step zero**: read about package maintenance tools (e.g [**devtools**](https://CRAN.R-project.org/package=dev*tools), [**lintr**]( https://CRAN.R-project.org/package=lintr), [**styler**](https://CRAN.R-project.org/package=styler), [CRAN guides](https://cran.r-project.org/), [*R Packages*](https://r-pkgs.org/) $2^{nd}$, and [R OpenSci recommendations](https://devguide.ropensci.org/index.html). This can be intimidating.
...
- Provide [transition tools](https://github.com/rvlenth/emmeans/tree/main/maintainer-notes): guides to package structure, how to prepare for CRAN.        
...
![Live shot of me and Russ collaborating](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExMm1sZG85b2NxYjB5dzcyN2YxcG9maWY0eDR2bWM2M3A4eTU1NndzMyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/8ZhtOfuU3ckLVPaOYo/giphy.gif)
...
- There are many opportunities for programmers of different levels; ROpenSci runs a '[Help Wanted](https://devguide.ropensci.org/index.html)' page with requests for help in solving issues or looking for new maintainers.
