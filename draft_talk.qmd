...
- Step two: make easy fixes (e.g. replace `aes_` with `aes`) and learn how to test them. Learn how to use '[testhat]()'.
...
Some people have big demands:

Do I need to accomodate this? 
...
![](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExMXQ2bm02ZWQ1aHh4MXZwYWloOHY5OHIxM3p3aTJ6bG55c3B6OGF3aiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/tj16BKlu9sexbFjDl7/giphy.gif)
(Russ is #14, I am #2)
...
- Many packages depend on emmeans, so every change has to be weighed with that in mind
- We have a script to check for that! But be careful, if something is broken downstream, that will be our probelm
...
In SAS, if you have covariates that interact with anything, center (or standardize) them first
