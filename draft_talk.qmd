...
-   My first package was **[rsm]()**
-   I had existing code that worked, and used `package.sketeton()` function 
...
-   Writing code is fun
-   Writing documentation & vignettes is less fun, and time-consuming. But really 
    important
...
2. I did not contribute for the next year; she answered issues, and looked more into package functionality
3. I became more involved starting last August with some encouragement from Russ ("please fix this...")


## How Did I Find My Way?

- Step zero: read up on package maintenance (this can be intimidating)
- Step one: answering issues build confidence to interact with the user base and understand what sort of attention to give each issue
- Step two: make easy fixes (e.g. replace `aes_` with `aes`) and learn how to test them. Learn how to use '[***testhat***](https://testthat.r-lib.org/)'.
- Step three: do more complex fixes: I added functionality
- Step four: collaborate with Russ on more complex thing (we overhauled plot aesthetics)


## Challenges: Filed Issues {.smaller}
...
Do I need to accomodate all of these? 
(Answer: sometimes, not always)

## Challenges: Breaking Dependencies

- Some issues are complex. The problem might be straightforward to describe, but what it is causing it is not easy to fix. 
- Fixing one issue may introduce new problems in the package. 
...
- Need clear two-way communication
...
![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2lrdzBxamg5aXk0OThzZmRmdjRpdGZrY2VsNmI5MzFseTh5cG91ZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/RtTrKqRYYxq118Vnsd/giphy.gif)
:::
...
- I do want to make a few changes: getting R to remove significant stars as the default, and expand the number of units tests. 
- Refactoring the code is a dream, but at this point, I don't dare. 
...
- AI: an agent (semi-autonomous) is an unwise choice at this time while Julia is still learning the code base 
- AI: can help with understanding code base
- Newer developers need nuturing and encourgement (or at least no discouragement) and some easy "wins" early on (programming problems that can )
...
![](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaWFicjA2dHhuMHg3dmVrNzBtcXV6dzV4bGh4aXo5OGVtcmRhazMwbSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/yDAcc4z3GltlmkJNIu/giphy.gif)
:::
